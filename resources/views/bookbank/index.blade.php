                                              ...
                                              <li>
                                                    ...
                                                    @method('POST')
                                                        ...
                                                        <input type="hidden" name="bookbankid"
                                                            value="{{ $bookbank->id }}">
                                                        <button type="submit" class="c-dropdown__item dropdown-item fetch-display-click btn-settle" data="bookbankid:{{ $bookbank->id }}" onclick="return confirm('Bạn có muốn tất toán sổ tiết kiệm này không?');">
                                             ...
                                             <li>
                                                 <form method="POST"
                                                     ...
                                                     <input type="hidden" name="bookbankid"
                                                         value="{{ $bookbank->id }}">
                                                     <button type="submit"
                                                         onclick="return confirm('Bạn có chắc xóa muốn sổ tiết kiệm này?')"
                                                         class="send-to-server-click btn-delete"
                                                         data="bookbankid:{{ $bookbank->id }}"
                                                         loader="true">
                                                         <i class="mdi mdi-delete"
